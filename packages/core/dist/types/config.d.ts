 ...
 */
export type SizingMethod = 'proportional_to_portfolio' | 'proportional_to_trader';
/**
 * What to do when calculated size is below minimum
 */
export type MinSizePolicy = 'skip' | 'place_minimum';
/**
 ...
 */
export declare const DEFAULT_COPY_CONFIG: CopyConfig;
