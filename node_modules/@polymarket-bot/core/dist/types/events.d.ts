...
import { OrderSpec, OrderResult } from './order';
import { Fill } from './position';
/**
 * All possible event types in our system
 */
export type EventType = 'trade_received' | 'trade_detected' | 'order_computed' | 'order_submitted' | 'order_filled' | 'order_cancelled' | 'order_failed' | 'position_updated' | 'risk_breach' | 'kill_switch' | 'error';
/**
 ...
 */
export type SystemEvent = TradeReceivedEvent | TradeDetectedEvent | OrderComputedEvent | OrderSubmittedEvent | OrderFilledEvent | OrderCancelledEvent | OrderFailedEvent | RiskBreachEvent | KillSwitchEvent | ErrorEvent;
