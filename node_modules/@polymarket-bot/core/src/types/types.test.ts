...
describe('Config Types', () => {
  it('should have valid DEFAULT_COPY_CONFIG', () => {
    expect(DEFAULT_COPY_CONFIG.sizingMethod).toBe('proportional_to_portfolio');
    expect(DEFAULT_COPY_CONFIG.portfolioPercentage).toBe(0.05);
    expect(DEFAULT_COPY_CONFIG.maxDailyLoss).toBe(100);
    expect(DEFAULT_COPY_CONFIG.maxTotalLoss).toBe(500);
  });
